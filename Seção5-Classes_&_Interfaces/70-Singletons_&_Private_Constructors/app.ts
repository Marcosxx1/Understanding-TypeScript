 /* 
70-Singletons_&_Private_Constructors
...
class DepartamentoContabilidade extends Departamento {
    ...
    private static instancia: DepartamentoContabilidade;
  ...
  //Getter
    ...
    private constructor(id: string, private relatorio: string[]){
        super(id, 'Contabil');
        this.ultimoRelatorio = relatorio[0];
    }

    static getInstancia(){
        if(DepartamentoContabilidade.instancia) {
            return this.instancia;
        } 
        this.instancia = new DepartamentoContabilidade('de', []);
        return this.instancia;
    }
...
//instanciando a classe utilizando 'Singleton' pattern
const contabilidade = DepartamentoContabilidade.getInstancia();
